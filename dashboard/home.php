...
<?php
    ...
    $weekInfo = $control->GetWeekInfo();
    $monthInfo = $control->GetMonthInfo();
    $allNewsEvents = $control->GetLimitNewsEvents();
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a  class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class="profile-pic m-r-5" /><span class="adminName">Markarn Doe </span></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Weekly Information/Quote</h4>
                                <div class="text-left">
                                    <?php echo nl2br($parsedown->text($weekInfo[1])); ?>
                                </div>
                                <div class="text-right"
                                <?php if (!is_null($user) && $user[11] != 1) {echo "style='display: none;'";} ?> >
                                    <span class="btn btn-primary" data-toggle="modal" data-target="#weekinfoModal" data-backdrop="static" data-keyboard="false">Update</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Monthly Information</h4>
                                <div class="text-left">
                                    <?php echo nl2br($parsedown->text($monthInfo[1])); ?>
                                </div>
                                <div class="text-right isAdmin" <?php if (!is_null($user) && $user[11] != 1) {echo "style='display: none;'";} ?>>
                                    <span class="btn btn-success"  data-toggle="modal" data-target="#monthinfoModal" data-backdrop="static" data-keyboard="false">Update</span>
                                </div>
                            </div>
                            </div>
                        </div>
        ...
        <!-- Weekly info Modal -->
        <div class="modal fade" id="weekinfoModal" tabindex="-1" role="dialog" aria-labelledby="weekinfoModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="weekinfoModalLabel">Weekly Info Update</h5>
                  ...
                  <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <form name="weekinfo" id="weekinfoForm" action="./../adminmanager.php">
                                <div class="form-group">
                                    <input type="hidden" name="weekinfo">
                                    <textarea class="form-control formInput" name="week_body" placeholder="New Weekly information/quote"></textarea>
                                </div>
                                <div class="form-group">
                                   <button id="weekinfoSubmit" type="submit" class="btn btn-success">Submit</button>
                                </div>
        ...
        <!-- Monthly info Modal -->
        <div class="modal fade" id="monthinfoModal" tabindex="-1" role="dialog" aria-labelledby="monthinfoModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="monthinfoModalLabel">Monthly Info/Event Update</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <form name="monthinfo" id="monthinfoForm" action="./../adminmanager.php">
                                <div class="form-group">
                                    <input type="hidden" name="monthinfo">
                                    <textarea class="form-control formInput" name="monthinfo_body" placeholder="New Monthly information/quote"></textarea>
                                </div>
                                <div class="form-group">
                                   <button id="monthinfoSubmit" type="submit" class="btn btn-success">Submit</button>
                                </div>
                                <img src="../assets/images/pie.gif" id="loading" style="display: none;" class="pull-right">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <img id="readNewsBannerImg" src="../" class="img img-responsive" style="min-width: 25%; margin-bottom: 10px;">
                        </div>
                        <div class="col-lg-12 col-md-12">
